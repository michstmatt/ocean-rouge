...
public partial class TrackingMob : RigidBody2D, IDamager, IKillable
{
	...
	public float GetDamageAmount() => Metadata.Damage;
	...
	{
		base._Ready();
		this.Metadata = EnemyFactory.GetEnemyMetadata(this.EnemyType).Instantiate();
	...
	public override void _IntegrateForces(PhysicsDirectBodyState2D state)
	{
		...
		this.Rotation = 0f;
		state.LinearVelocity = vectorTo * Metadata.Speed / state.Step;
